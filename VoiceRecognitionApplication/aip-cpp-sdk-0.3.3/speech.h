...
namespace aip {
    ...
    public:
                                  ...
                                  std::string & file_content)
        {
            ...
            int status_code = this->client.post(url, nullptr, data, nullptr, &response);
            //int status_code = this->client.get("http://tsn.baidu.com/text2audio?tex=%E4%BD%A0%E5%A5%BD%E6%98%AF%E9%97%AB%E4%BC%9A%E8%B6%85%E5%90%97&lan=zh&cuid=f1TKqPxGYT3nt6kQFkO2izSn&ctp=1&tok=24.29581aba69fa90edf75d8087397cdcdc.2592000.1515761996.282335-10527831", nullptr, nullptr, &response);
            if (status_code != CURLcode::CURLE_OK) {
                obj[aip::CURL_ERROR_CODE] = status_code;
                return obj;
            }
